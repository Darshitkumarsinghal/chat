        ...
        >
            <Box className={classname.component}>
                <Box className={classname.dialog}>
                    <Typography className={classname.title}>To use ChatApp on your computer:</Typography>
                    <List className={classname.list}>
                        <ListItem>1. Login with your Google ID</ListItem>
                        <ListItem>2. Search your friends email id </ListItem>
                        <ListItem>3. Say Hii 👋</ListItem>
                    </List>
